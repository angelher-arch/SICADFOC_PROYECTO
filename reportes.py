...
def reporte_estudiantes(db):
    ...
    try:
        ...
        if estudiantes and isinstance(estudiantes, list) and len(estudiantes) > 0 and isinstance(estudiantes[0], dict):
...
def reporte_profesores(db):
    ...
    try:
        ...
        if profesores and isinstance(profesores, list) and len(profesores) > 0 and isinstance(profesores[0], dict):
...
def reporte_mi_progreso(db, rol_usuario):
    ...
    try:
        ...
        if estudiante:
            ...
            if inscripciones and isinstance(inscripciones, list) and len(inscripciones) > 0 and isinstance(inscripciones[0], dict):
...
def reporte_mis_certificados(db, rol_usuario):
    ...
    try:
        ...
        if certificados and isinstance(certificados, list) and len(certificados) > 0 and isinstance(certificados[0], dict):
