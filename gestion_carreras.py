...
class GestionCarreras:
    ...
    def mostrar_estadisticas_carreras(self):
        ...
        try:
            ...
            with col1:
                if resultado_total:
                    st.metric("Total Carreras", resultado_total[0]['total'] if isinstance(resultado_total, list) else resultado_total.get('total', 0))
            
            with col2:
                if resultado_activas:
                    st.metric("Carreras Activas", resultado_activas[0]['activas'] if isinstance(resultado_activas, list) else resultado_activas.get('activas', 0))
