...
class DatabaseManager:
    ...
    def _load_config(self):
        """CONFIGURACIÓN DUAL - Producción (Render) vs Local"""
        # LIMPIEZA DE CACHÉ - Inicializar desde cero
        self._connection = None
        
        # Prioridad 1: Producción (Render) - DATABASE_URL
        ...
        if database_url:
            ...
            self.config = {
                ...
                'sslmode': 'require',  # Requerido para Render
            ...
            print("CONEXIÓN EXTERNA - RENDER PRODUCCIÓN")
            ...
            self.config = {
                ...
                'user': 'postgres',
                'password': 'admin123',
                'sslmode': 'prefer'  # Opcional para desarrollo local
            }
            ...
            print("CONEXIÓN LOCAL - DESARROLLO")
