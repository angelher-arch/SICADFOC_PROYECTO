...
def _configurar_tesseract_bajo_demanda():
    ...
    try:
        ...
        # Configuración silenciosa para producción
        try:
            TESSERACT_VERSION = pytesseract.get_tesseract_version()
            OCR_AVAILABLE = True
            # Solo log a consola, no a UI
            print(f"OCR Tesseract {TESSERACT_VERSION} inicializado bajo demanda")
            return
        except Exception:
            pass  # Continuar en silencio
        
        # Configurar ruta automáticamente si PATH no funciona
        rutas_posibles = [
