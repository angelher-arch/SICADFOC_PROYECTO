...
class ConexionPostgreSQL:
    ...
    def _configurar_conexion(self):
        ...
        try:
            ...
            if database_url and database_url.strip():
                ...
                logger.warning("⚠️ DATABASE_URL no encontrada, usando fallback local")
    ...
    def _configurar_local(self):
        ...
        self.database = os.getenv('DB_NAME', 'sicad_foc26')
    ...
    def conectar(self):
        ...
        try:
            ...
            # Parámetros de conexión con SSL obligatorio para Railway
            connection_params = {
                'host': self.host,
                'port': self.port,
    ...
    def obtener_info_conexion(self):
        ...
        return {
            ...
            'user': self.user,
            'sslmode': 'require',
            'source': 'railway' if os.getenv('DATABASE_URL') else 'local'
        }
